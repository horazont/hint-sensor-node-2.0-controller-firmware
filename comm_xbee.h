...
class CommXBEETX: public Coroutine
{
public:
...
public:
    CommXBEETX() = delete;
    explicit CommXBEETX(USART &usart);
...
class CommXBEERX: public Coroutine
{
public:
...
public:
    CommXBEERX() = delete;
    explicit CommXBEERX(USART &usart);

private:
    static CommXBEERX *m_xbee;
