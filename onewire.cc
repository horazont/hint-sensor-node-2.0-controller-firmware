...
static const uint8_t ONEWIRE_SEARCH_REQ = 0xf0;
...
OnewireReadBytes::OnewireReadBytes(OnewireCore &core):
    m_core(core)
{
...
ASYNC_CALLABLE OnewireFindNext::step(const stm32_clock::time_point now)
{
    ...
    await_call(m_write_bytes, &ONEWIRE_SEARCH_REQ, 1);
